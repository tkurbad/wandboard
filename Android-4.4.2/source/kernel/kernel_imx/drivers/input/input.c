...
void input_dev_calibrate(struct input_dev *dev, int *x, int *y, int xmax, int ymax) {
        if (dev->calibration[6] > 0) {
                int tx = (dev->calibration[0] * *x + dev->calibration[1] * *y + dev->calibration[2]) / dev->calibration[6];
                int ty = (dev->calibration[3] * *x + dev->calibration[4] * *y + dev->calibration[5]) / dev->calibration[6];
